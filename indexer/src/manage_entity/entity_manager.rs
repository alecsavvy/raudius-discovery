...
mod entity_manager {
        ...
        pub fn raw_contract() -> &'static self::ethcontract::Contract {
            ...
            lazy_static! {
                pub static ref CONTRACT: Contract = {
                    # [allow (unused_mut)] let mut contract = TruffleLoader :: new () . load_contract_from_str ("{\"contractName\":\"EntityManager\",\"abi\":[{\"type\":\"function\",\"name\":\"initialize\",\"inputs\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"chainId\",\"type\":\"uint256\"}],\"outputs\":[],\"constant\":false,\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"initialize\",\"inputs\":[{\"name\":\"_verifierAddress\",\"type\":\"address\"},{\"name\":\"_networkId\",\"type\":\"uint256\"}],\"outputs\":[],\"constant\":false,\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"manageEntity\",\"inputs\":[{\"name\":\"_userId\",\"type\":\"uint256\"},{\"name\":\"_entityType\",\"type\":\"string\"},{\"name\":\"_entityId\",\"type\":\"uint256\"},{\"name\":\"_action\",\"type\":\"string\"},{\"name\":\"_metadata\",\"type\":\"string\"},{\"name\":\"_nonce\",\"type\":\"bytes32\"},{\"name\":\"_subjectSig\",\"type\":\"bytes\"}],\"outputs\":[],\"constant\":false,\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"manageIsVerified\",\"inputs\":[{\"name\":\"_userId\",\"type\":\"uint256\"},{\"name\":\"_isVerified\",\"type\":\"bool\"}],\"outputs\":[],\"constant\":false,\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"usedSignatures\",\"inputs\":[{\"name\":\"\",\"type\":\"bytes32\"}],\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"constant\":true,\"stateMutability\":\"view\"},{\"type\":\"event\",\"name\":\"ManageEntity\",\"inputs\":[{\"name\":\"_userId\",\"type\":\"uint256\",\"indexed\":false},{\"name\":\"_signer\",\"type\":\"address\",\"indexed\":false},{\"name\":\"_entityType\",\"type\":\"string\",\"indexed\":false},{\"name\":\"_entityId\",\"type\":\"uint256\",\"indexed\":false},{\"name\":\"_metadata\",\"type\":\"string\",\"indexed\":false},{\"name\":\"_action\",\"type\":\"string\",\"indexed\":false}],\"anonymous\":false},{\"type\":\"event\",\"name\":\"ManageIsVerified\",\"inputs\":[{\"name\":\"_userId\",\"type\":\"uint256\",\"indexed\":false},{\"name\":\"_isVerified\",\"type\":\"bool\",\"indexed\":false}],\"anonymous\":false}],\"bytecode\":\"\",\"deployedBytecode\":\"\",\"networks\":{},\"devdoc\":{\"details\":null,\"methods\":{}},\"userdoc\":{\"details\":null,\"methods\":{}}}") . expect ("valid contract JSON") ;
                    contract
                };
            }
            &CONTRACT
    ...
    impl Signatures {
        #[doc = "Returns signature for method `initialize(string,string,uint256)`."]
        #[allow(clippy::type_complexity)]
        pub fn init(
            &self,
        ) -> self::ethcontract::contract::Signature<(String, String, self::ethcontract::U256), ()>
        {
            self::ethcontract::contract::Signature::new([177, 25, 73, 14])
        }
    ...
    impl Methods {
        ...
        pub fn init(
            ...
            name: String,
            version: String,
            chain_id: self::ethcontract::U256,
        ) -> self::ethcontract::dyns::DynMethodBuilder<()> {
            self.instance
                .method([177, 25, 73, 14], (name, version, chain_id))
